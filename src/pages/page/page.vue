...
export default {
    ...
    computed: {
        ...
        isShowTabbar() {
            if (/detail|ceshi|storeer|store_users|addgoods|storeInfo|shop|order|commodityData|platform|message|income|recharge|principal|withdraw|billingDetails|service|aboutUs/.test(this.$route.path)) {
                return true
            }
            return false
        },
